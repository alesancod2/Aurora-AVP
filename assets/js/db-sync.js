...
const DbSync = (function () {
    ...
    function mapVenda(raw) {
        return {
            ...
            vendas_situacao_enum: raw.VendasSituacaoEnum ? parseInt(String(raw.VendasSituacaoEnum)) : 5,
            vendas_situacao: raw.VendasSituacao || 'Novo',
            vendas_data_cadastro: raw.VendasDataCadastro || null,
            vendas_data_ativacao: (raw.VendasDataAtivacao && raw.VendasDataAtivacao !== '-') ? raw.VendasDataAtivacao : null,
